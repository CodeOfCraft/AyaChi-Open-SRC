...
namespace GameData {
	...
	namespace VTableIndex {
		...
		namespace ClientInstance {
			...
			inline constexpr int getCameraActor = 0x26;
			inline constexpr int getCameraTargetActor = 0x29;
			inline constexpr int isLeavingGame = 0x2F;
			inline constexpr int isDestroyingGame = 0x30;
			inline constexpr int isShuttingDown = 0x31;
			inline constexpr int isSplitScreenActive = 0x33;
			inline constexpr int isExitingLevel = 0x34;
			inline constexpr int isInBedScreen = 0x35;
			inline constexpr int isInDeathScreen = 0x36;
			inline constexpr int isKeyboardEnabled = 0x37;
			inline constexpr int hasCommands = 0x38;
			inline constexpr int getSplitScreenCount = 0x39;
			inline constexpr int isShowingLoadingScreen = 0x3A;
			inline constexpr int isReadyToRender = 0x84;
			inline constexpr int useController = 0x90;
			inline constexpr int useTouchscreen = 0x91;
			inline constexpr int getMinecraftGame = 0x4F;
			inline constexpr int getMouseGrabbed = 0x92;
			inline constexpr int currentInputModeIsMouseAndKeyboard = 0x93;
			inline constexpr int allowPicking = 0x94;
			inline constexpr int isShowingMenu = 0x95;
			inline constexpr int isShowingPauseScreen = 0x96;
			inline constexpr int isShowingProgressScreen = 0x97;
			inline constexpr int isShowingWorldProgressScreen = 0x98;
			inline constexpr int isShowingRealmsProgressScreen = 0x99;
			inline constexpr int isShowingDeathScreen = 0x9A;
			inline constexpr int isShowingServerForm = 0x9B;
			inline constexpr int isScreenReplaceable = 0x9C;
			inline constexpr int getLevel = 0xA7;
			inline constexpr int isWorldActive = 0x9E;
			inline constexpr int isInRealm = 0x9F;
			inline constexpr int readyForShutdown = 0xA0;
			inline constexpr int isPrimaryClient = 0xA1;
			inline constexpr int isEduMode = 0xA2;
			inline constexpr int isGamepadCursorEnabled = 0xA3;
			inline constexpr int isInControlCustomization = 0xA4;
			inline constexpr int getServerData = 0xA5;
			inline constexpr int hasLevel = 0xA9;
			inline constexpr int isPreGame = 0xAA;
			inline constexpr int isInMultiplayerGame = 0xAB;
			inline constexpr int isMultiPlayerClient = 0xAC;
			...
			inline constexpr int shouldRenderUICursor = 0xD0;
			inline constexpr int getRenderPlayerModel = 0xD1;
			inline constexpr int getGuiScale = 0xD3;
			inline constexpr int getGuiData = 0xD8;
			inline constexpr int getCurrentInputMode = 0x108;
			inline constexpr int getMinecraftInput = 0x10A;
			inline constexpr int getLastPointerLocation = 0x10D;
			inline constexpr int getTouchPointerLocation = 0x11E;
			inline constexpr int getActionPointerId = 0x120;
			inline constexpr int getPacketSender = 0x124;
			inline constexpr int getInput = 0x12E;
			inline constexpr int getControllerId = 0x12F;
			inline constexpr int hasConnectedController = 0x130;
			inline constexpr int grabMouse = 0x135;
			inline constexpr int releaseMouse = 0x136;
			inline constexpr int refocusMouse = 0x137;
			inline constexpr int getSoundEngine = 0x13B;
			inline constexpr int getMusicManager = 0x13C;
			inline constexpr int isFullVanillaPackOnStack = 0x145;
			inline constexpr int getItemInHandRenderer = 0x160;
